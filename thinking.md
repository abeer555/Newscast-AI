...
| minimaxai/minimax-m2.7       | [MiniMax M2.7](https://console.groq.com/docs/model/minimaxai/minimax-m2.7)                       |
...
| reasoning\_effort       | default        | "none", "default", "low", "medium", "high" | Controls the level of effort the model will put into reasoning. none and default are only supported by [Qwen 3.6 27B](https://console.groq.com/docs/model/qwen/qwen3.6-27b). low, medium, and high are only supported by [GPT-OSS 20B](https://console.groq.com/docs/model/openai/gpt-oss-20b) and [GPT-OSS 120B](https://console.groq.com/docs/model/openai/gpt-oss-120b). |
